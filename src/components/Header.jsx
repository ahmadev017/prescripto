  ...
  return (
    ...
    {/******     Left  *************/}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-4 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        </div>          <a className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#speciality">Book appointments <img className='w-3' src={assets.arrow_icon} alt="" /></a>
      </div>
      {/*************  Right  ************** */} 
